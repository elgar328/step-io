...
fn main() {
    ...
    // Per-target output profiles (legal set / downgrade / header), baked from the
    // vendored schema/ap*.toml into const tables for the per-schema writer.
    let profile_specs = [
        ("AP214E3", "Ap214", "ap214e3"),
        ("AP242E2", "Ap242", "ap242e2"),
        ("AP203E2", "Ap203", "ap203e2"),
    ];
