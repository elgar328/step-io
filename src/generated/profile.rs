...
//! Per-target output SchemaProfiles (legal set / downgrade / header).
...
impl SchemaProfile {
    ...
    pub fn is_legal(&self, kw: &str) -> bool {
        self.legal.binary_search(&kw).is_ok()
    }
    /// Rename-safe supertype for an illegal subtype `kw`, if any.
    pub fn downgrade(&self, kw: &str) -> Option<&'static str> {
        self.downgrade
            .binary_search_by(|&(s, _)| s.cmp(kw))
            .ok()
            .map(|i| self.downgrade[i].1)
    }
    pub fn for_target(t: SchemaTarget) -> Option<&'static SchemaProfile> {
        match t {
            SchemaTarget::Universal => None,
            SchemaTarget::Ap214 => Some(&AP214E3),
            SchemaTarget::Ap242 => Some(&AP242E2),
            SchemaTarget::Ap203 => Some(&AP203E2),
        }
    }
}

static AP214E3_LEGAL: &[&str] = &[
    "ABS_FUNCTION",
    "ACOS_FUNCTION",
    "ACTION",
    "ACTION_ASSIGNMENT",
...
static AP214E3_DOWNGRADE: &[(&str, &str)] = &[
    (
        "A3MA_LENGTH_MEASURE_AND_CONTEXT_DEPENDENT_MEASURE_PAIR",
        "COMPOUND_REPRESENTATION_ITEM",
    ),
    ("A3M_EQUIVALENCE_CRITERIA_REPRESENTATION", "REPRESENTATION"),
    ...
    ("ACTION_ACTUAL", "EXECUTED_ACTION"),
    ("ACTION_HAPPENING", "ACTION_RELATIONSHIP"),
    (
        "ADDITIVE_MANUFACTURING_BUILD_PLATE_RELATIONSHIP",
        "NEXT_ASSEMBLY_USAGE_OCCURRENCE",
    ),
    ("ADDITIVE_MANUFACTURING_SETUP", "PRODUCT"),
    (
    ...
    ("ALL_AROUND_SHAPE_ASPECT", "COMPOSITE_SHAPE_ASPECT"),
    ("ANALYSIS_ASSIGNMENT", "GROUP"),
    ("ANALYSIS_REPRESENTATION_CONTEXT", "REPRESENTATION_CONTEXT"),
    ("ASSEMBLY_BOND_DEFINITION", "SHAPE_ASPECT"),
    ("ASSEMBLY_SHAPE_CONSTRAINT", "SHAPE_ASPECT"),
    ("ASSEMBLY_SHAPE_JOINT", "SHAPE_ASPECT"),
    ("ATOMIC_FORMULA", "COMPOUND_REPRESENTATION_ITEM"),
    ("ATTACHMENT_SLOT_AS_PLANNED", "PRODUCT_DEFINITION_FORMATION"),
    (
        "ATTACHMENT_SLOT_AS_REALIZED",
        "PRODUCT_DEFINITION_FORMATION",
    ),
    ("ATTACHMENT_SLOT_DESIGN", "PRODUCT_DEFINITION_FORMATION"),
    (
        "ATTACHMENT_SLOT_ON_PRODUCT",
        "PRODUCT_DEFINITION_RELATIONSHIP",
    ),
    ("BACK_CHAINING_RULE", "PRODUCT_DEFINITION"),
    ("BETWEEN_SHAPE_ASPECT", "COMPOSITE_SHAPE_ASPECT"),
    ("BEVELED_SHEET_REPRESENTATION", "SHAPE_REPRESENTATION"),
    ("BOUND_PARAMETER_ENVIRONMENT", "ENVIRONMENT"),
    ("BOUND_VARIABLE_SEMANTICS", "VARIABLE_SEMANTICS"),
    ...
    ("CARTESIAN_11", "GEOMETRIC_REPRESENTATION_ITEM"),
    ("CHANGE_GROUP", "GROUP"),
    ...
    ("CLOSED_CURVE_STYLE_PARAMETERS", "REPRESENTATION"),
    ("COLLECTION", "PRODUCT"),
    ("COLLECTION_ASSIGNMENT", "APPLIED_GROUP_ASSIGNMENT"),
    ("COLLECTION_MEMBERSHIP", "APPLIED_GROUP_ASSIGNMENT"),
    ("COMPLEX_AREA", "GEOMETRIC_REPRESENTATION_ITEM"),
    ("COMPLEX_CLAUSE", "COMPOUND_REPRESENTATION_ITEM"),
    ("COMPLEX_CONJUNCTIVE_CLAUSE", "COMPOUND_REPRESENTATION_ITEM"),
    ("COMPLEX_DISJUNCTIVE_CLAUSE", "COMPOUND_REPRESENTATION_ITEM"),
    ("COMPONENT_MATING_CONSTRAINT_CONDITION", "SHAPE_ASPECT"),
    ("COMPOSITE_ASSEMBLY_DEFINITION", "PRODUCT_DEFINITION"),
    (
        "COMPOSITE_ASSEMBLY_SEQUENCE_DEFINITION",
        "PRODUCT_DEFINITION",
    ),
    ("COMPOSITE_ASSEMBLY_TABLE", "PRODUCT_DEFINITION"),
    ...
    ("CONDITION", "ACTION_METHOD"),
    ("CONDUCTANCE_MEASURE_WITH_UNIT", "MEASURE_WITH_UNIT"),
    ("CONDUCTANCE_UNIT", "DERIVED_UNIT"),
    ("CONNECTIVITY_DEFINITION", "SHAPE_ASPECT"),
    ("CONTACTING_FEATURE", "SHAPE_ASPECT"),
    ("CONTACT_FEATURE", "SHAPE_ASPECT"),
    ("CONTACT_FEATURE_DEFINITION", "CHARACTERIZED_OBJECT"),
    ("CONTINUOUS_SHAPE_ASPECT", "COMPOSITE_SHAPE_ASPECT"),
    ("CROSS_SECTIONAL_ALTERNATIVE_SHAPE_ELEMENT", "SHAPE_ASPECT"),
    ("CROSS_SECTIONAL_GROUP_SHAPE_ELEMENT", "SHAPE_ASPECT"),
    (
    ...
    ("CROSS_SECTIONAL_OCCURRENCE_SHAPE_ELEMENT", "SHAPE_ASPECT"),
    ("CROSS_SECTIONAL_PART_SHAPE_ELEMENT", "SHAPE_ASPECT"),
    ("CURRENCY", "CONTEXT_DEPENDENT_UNIT"),
    ("CURVE_11", "GEOMETRIC_REPRESENTATION_ITEM"),
    ("CURVE_STYLE_PARAMETERS_REPRESENTATION", "REPRESENTATION"),
    ("CURVE_STYLE_PARAMETERS_WITH_ENDS", "REPRESENTATION"),
    ("CYLINDRICAL_11", "GEOMETRIC_REPRESENTATION_ITEM"),
    ("DATA_EQUIVALENCE_CRITERIA_REPRESENTATION", "REPRESENTATION"),
    ("DATA_EQUIVALENCE_CRITERION", "REPRESENTATION_ITEM"),
    (
    ...
    ("ENTITY_ASSERTION", "PROPERTY_DEFINITION"),
    ...
    ("FORWARD_CHAINING_RULE", "PRODUCT_DEFINITION"),
    ("FREE_VARIABLE_SEMANTICS", "VARIABLE_SEMANTICS"),
    ...
    ("GROUND_FACT", "COMPOUND_REPRESENTATION_ITEM"),
    ("HARNESS_NODE", "SHAPE_ASPECT"),
    ("HARNESS_SEGMENT", "SHAPE_ASPECT"),
    ("HIERARCHICAL_INTERFACE_CONNECTION", "GROUP"),
    ...
    ("INTERFACE_CONNECTOR_DESIGN", "PRODUCT_DEFINITION_FORMATION"),
    ...
    ("IN_ZONE", "GROUP"),
    ("ISO4217_CURRENCY", "CONTEXT_DEPENDENT_UNIT"),
    ...
    ("LITERAL_CONJUNCTION", "COMPOUND_REPRESENTATION_ITEM"),
    ("LITERAL_DISJUNCTION", "COMPOUND_REPRESENTATION_ITEM"),
    ...
    ("MACHINING_PROCESS_EXECUTABLE", "PROCESS_OPERATION"),
    (
    ...
    ("PART_LAMINATE_TABLE", "PRODUCT_DEFINITION"),
    ("PERCENTAGE_LAMINATE_DEFINITION", "PRODUCT_DEFINITION"),
    ("PERCENTAGE_LAMINATE_TABLE", "PRODUCT_DEFINITION"),
    ("PERCENTAGE_PLY_DEFINITION", "PRODUCT_DEFINITION"),
    (
        "PHYSICAL_BREAKDOWN_CONTEXT",
        "PRODUCT_DEFINITION_RELATIONSHIP",
    ),
    ("PHYSICAL_ELEMENT_USAGE", "PRODUCT_DEFINITION_RELATIONSHIP"),
    ("PLY_LAMINATE_DEFINITION", "PRODUCT_DEFINITION"),
    ("PLY_LAMINATE_SEQUENCE_DEFINITION", "PRODUCT_DEFINITION"),
    ("PLY_LAMINATE_TABLE", "PRODUCT_DEFINITION"),
    ("POLAR_11", "GEOMETRIC_REPRESENTATION_ITEM"),
    (
    ...
    ("PRODUCT_GROUP", "GROUP"),
    ("PRODUCT_GROUP_ATTRIBUTES", "GROUP"),
    ("PRODUCT_GROUP_CONTEXT", "DESCRIPTIVE_REPRESENTATION_ITEM"),
    ("PRODUCT_GROUP_PURPOSE", "DESCRIPTIVE_REPRESENTATION_ITEM"),
    ("PRODUCT_GROUP_RELATIONSHIP", "GROUP_RELATIONSHIP"),
    ("PRODUCT_GROUP_RULE", "DESCRIPTIVE_REPRESENTATION_ITEM"),
    ("PRODUCT_GROUP_RULES", "GROUP"),
    (
    ...
    ("RULE_ACTION", "ACTION"),
    ("RULE_CONDITION", "COMPOUND_REPRESENTATION_ITEM"),
    ("RULE_DEFINITION", "PRODUCT_DEFINITION"),
    ("RULE_SET", "PRODUCT_DEFINITION"),
    ("RULE_SET_GROUP", "PRODUCT_DEFINITION"),
    ("RULE_SOFTWARE_DEFINITION", "PRODUCT_DEFINITION"),
    ("RULE_SUPERSEDENCE", "ACTION"),
    ("SATISFIES_REQUIREMENT", "GROUP"),
    ("SCANNED_DATA_ITEM", "GEOMETRIC_REPRESENTATION_ITEM"),
    ("SCANNER_PROPERTY", "REPRESENTATION_ITEM"),
    (
    ...
    ("SHAPE_FEATURE_DEFINITION", "CHARACTERIZED_OBJECT"),
    (
        "SHELL_BASED_WIREFRAME_SHAPE_REPRESENTATION",
        "SHAPE_REPRESENTATION",
    ),
    ("SIMPLE_CLAUSE", "COMPOUND_REPRESENTATION_ITEM"),
    ("SMEARED_MATERIAL_DEFINITION", "PRODUCT_DEFINITION"),
    ...
    ("SYSTEM_ELEMENT_USAGE", "PRODUCT_DEFINITION_RELATIONSHIP"),
    ...
    ("TERMINAL_FEATURE", "SHAPE_ASPECT"),
    ("TERMINAL_LOCATION_GROUP", "SHAPE_ASPECT"),
    ("TESSELLATED_ITEM", "GEOMETRIC_REPRESENTATION_ITEM"),
    (
        "TESSELLATED_STRUCTURED_ITEM",
        "GEOMETRIC_REPRESENTATION_ITEM",
    ),
    ("TEXTURE_STYLE_SPECIFICATION", "FOUNDED_ITEM"),
    ("TEXTURE_STYLE_TESSELLATION_SPECIFICATION", "FOUNDED_ITEM"),
    ("THERMAL_RESISTANCE_MEASURE_WITH_UNIT", "MEASURE_WITH_UNIT"),
    ("THERMAL_RESISTANCE_UNIT", "DERIVED_UNIT"),
    ("THICKNESS_LAMINATE_DEFINITION", "PRODUCT_DEFINITION"),
    ("THICKNESS_LAMINATE_TABLE", "PRODUCT_DEFINITION"),
    ("THREAD_RUNOUT", "SHAPE_ASPECT"),
    ("TRANSPORT_FEATURE", "SHAPE_ASPECT"),
    ...
    ("USER_DEFINED_11", "REPRESENTATION_ITEM"),
    ("VALIDATION", "GROUP"),
    ...
    ("ZONE_BREAKDOWN_CONTEXT", "PRODUCT_DEFINITION_RELATIONSHIP"),
    ("ZONE_ELEMENT_USAGE", "PRODUCT_DEFINITION_RELATIONSHIP"),
    ("ZONE_STRUCTURAL_MAKEUP", "PRODUCT_DEFINITION"),
];
static AP214E3_FILE_SCHEMA: &[&str] = &["AUTOMOTIVE_DESIGN { 1 0 10303 214 3 1 1 }"];
static AP214E3: SchemaProfile = SchemaProfile {
    legal: AP214E3_LEGAL,
    downgrade: AP214E3_DOWNGRADE,
    file_schema: AP214E3_FILE_SCHEMA,
    apd: ApdInfo {
        status: "international standard",
        name: "automotive_design",
        year: 2009,
        description: "Core Data for Automotive Mechanical Design Process",
    },
};
static AP242E2_LEGAL: &[&str] = &[
...
static AP242E2_DOWNGRADE: &[(&str, &str)] = &[
    ("COMPOSITE_ASSEMBLY_DEFINITION", "PRODUCT_DEFINITION"),
...
static AP242E2_FILE_SCHEMA: &[&str] =
    &["AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF { 1 0 10303 442 3 1 4 }"];
static AP242E2: SchemaProfile = SchemaProfile {
    legal: AP242E2_LEGAL,
    downgrade: AP242E2_DOWNGRADE,
    file_schema: AP242E2_FILE_SCHEMA,
    apd: ApdInfo {
        status: "international standard",
...
static AP203E2_DOWNGRADE: &[(&str, &str)] = &[
    (
        "A3MA_LENGTH_MEASURE_AND_CONTEXT_DEPENDENT_MEASURE_PAIR",
        "COMPOUND_REPRESENTATION_ITEM",
    ),
    ("A3M_EQUIVALENCE_CRITERIA_REPRESENTATION", "REPRESENTATION"),
    ("ABS_FUNCTION", "UNARY_NUMERIC_EXPRESSION"),
    ("ACOS_FUNCTION", "UNARY_NUMERIC_EXPRESSION"),
    ("ACTION_ACTUAL", "EXECUTED_ACTION"),
    ("ACTION_HAPPENING", "ACTION_RELATIONSHIP"),
    (
        "ADDITIVE_MANUFACTURING_BUILD_PLATE_RELATIONSHIP",
    ...
    ("ASIN_FUNCTION", "UNARY_NUMERIC_EXPRESSION"),
    ("ASSEMBLY_BOND_DEFINITION", "SHAPE_ASPECT"),
    ("ASSEMBLY_SHAPE_CONSTRAINT", "SHAPE_ASPECT"),
    ("ASSEMBLY_SHAPE_JOINT", "SHAPE_ASPECT"),
    ("ATAN_FUNCTION", "BINARY_NUMERIC_EXPRESSION"),
    ("ATTACHMENT_SLOT_AS_PLANNED", "PRODUCT_DEFINITION_FORMATION"),
    (
        "ATTACHMENT_SLOT_AS_REALIZED",
        "PRODUCT_DEFINITION_FORMATION",
    ...
    ("COMPONENT_MATING_CONSTRAINT_CONDITION", "SHAPE_ASPECT"),
    ("COMPOSITE_GROUP_SHAPE_ASPECT", "COMPOSITE_SHAPE_ASPECT"),
    ("COMPOSITE_HOLE", "CHARACTERIZED_OBJECT"),
    ("COMPOSITE_UNIT_SHAPE_ASPECT", "COMPOSITE_SHAPE_ASPECT"),
    ("COMPOUND_FEATURE", "CHARACTERIZED_OBJECT"),
    ("CONDITION", "ACTION_METHOD"),
    ("CONNECTIVITY_DEFINITION", "SHAPE_ASPECT"),
    ("CONTACTING_FEATURE", "SHAPE_ASPECT"),
    ("CONTACT_FEATURE", "SHAPE_ASPECT"),
    ("CONTACT_FEATURE_DEFINITION", "SHAPE_FEATURE_DEFINITION"),
    ("CONTINUOUS_SHAPE_ASPECT", "COMPOSITE_SHAPE_ASPECT"),
    ("COS_FUNCTION", "UNARY_NUMERIC_EXPRESSION"),
    ("CROSS_SECTIONAL_ALTERNATIVE_SHAPE_ELEMENT", "SHAPE_ASPECT"),
    ("CROSS_SECTIONAL_GROUP_SHAPE_ELEMENT", "SHAPE_ASPECT"),
    (
        "CROSS_SECTIONAL_GROUP_SHAPE_ELEMENT_WITH_LACING",
    ...
    ("EDGE_ROUND", "SHAPE_ASPECT"),
    ("ELEMENT_DELIVERY", "ACTION"),
    (
        "EVALUATED_CHARACTERISTIC_OF_PRODUCT_AS_INDIVIDUAL_TEST_RESULT",
        "EVALUATED_CHARACTERISTIC",
    ),
    ("EXP_FUNCTION", "UNARY_NUMERIC_EXPRESSION"),
    (
        "EXTERNALLY_CONDITIONED_DATA_QUALITY_CRITERIA_REPRESENTATION",
        "REPRESENTATION",
    ),
    ...
    ("FEATURE_IN_PANEL", "CHARACTERIZED_OBJECT"),
    ("FEATURE_PATTERN", "CHARACTERIZED_OBJECT"),
    ("FILLET", "SHAPE_ASPECT"),
    ("FLAT_FACE", "CHARACTERIZED_OBJECT"),
    ("FREE_VARIABLE_SEMANTICS", "VARIABLE_SEMANTICS"),
    ("GEAR", "CHARACTERIZED_OBJECT"),
    ("GENERAL_FEATURE", "CHARACTERIZED_OBJECT"),
    ("GEOMETRIC_CONTACT", "DERIVED_SHAPE_ASPECT"),
    ("HARNESS_NODE", "SHAPE_ASPECT"),
    ("HARNESS_SEGMENT", "SHAPE_ASPECT"),
    ("HIERARCHICAL_INTERFACE_CONNECTION", "GROUP"),
    ("HOLE_BOTTOM", "SHAPE_ASPECT"),
    ("HOLE_IN_PANEL", "CHARACTERIZED_OBJECT"),
    ("INTERFACE_CONNECTION", "GROUP"),
    (
        "INTERFACE_CONNECTOR_AS_PLANNED",
        "PRODUCT_DEFINITION_FORMATION",
    ...
    ("LOCATOR", "CHARACTERIZED_OBJECT"),
    ("LOG10_FUNCTION", "UNARY_NUMERIC_EXPRESSION"),
    ("LOG2_FUNCTION", "UNARY_NUMERIC_EXPRESSION"),
    ("LOG_FUNCTION", "UNARY_NUMERIC_EXPRESSION"),
    ("MACHINING_PROCESS_EXECUTABLE", "ACTION_METHOD"),
    ("MARKING", "CHARACTERIZED_OBJECT"),
    ("MATHS_FUNCTION", "GENERIC_EXPRESSION"),
    ("MATHS_SPACE", "GENERIC_EXPRESSION"),
    ("MAXIMUM_FUNCTION", "MULTIPLE_ARITY_NUMERIC_EXPRESSION"),
    ("MESSAGE_CONTENTS_GROUP", "GROUP"),
    ("MINIMUM_FUNCTION", "MULTIPLE_ARITY_NUMERIC_EXPRESSION"),
    ("MINUS_EXPRESSION", "BINARY_NUMERIC_EXPRESSION"),
    ("MINUS_FUNCTION", "UNARY_NUMERIC_EXPRESSION"),
    ("MODIFIED_PATTERN", "CHARACTERIZED_OBJECT"),
    ...
    ("OUTER_ROUND", "CHARACTERIZED_OBJECT"),
    ("OUTSIDE_PROFILE", "CHARACTERIZED_OBJECT"),
    ("PARTIAL_CIRCULAR_PROFILE", "SHAPE_ASPECT"),
    ("PATH_FEATURE_COMPONENT", "SHAPE_ASPECT"),
    ("PATH_SHAPE_REPRESENTATION", "SHAPE_REPRESENTATION"),
    ("PATTERN_OFFSET_MEMBERSHIP", "SHAPE_ASPECT_RELATIONSHIP"),
    ("PATTERN_OMIT_MEMBERSHIP", "SHAPE_ASPECT_RELATIONSHIP"),
    (
        "PHYSICALLY_MODELLED_PRODUCT_DEFINITION",
        "PRODUCT_DEFINITION_WITH_ASSOCIATED_DOCUMENTS",
    ),
    ...
    ("PROFILE_FLOOR", "SHAPE_ASPECT"),
    ("PROTRUSION", "CHARACTERIZED_OBJECT"),
    ("RECTANGULAR_CLOSED_PROFILE", "SHAPE_ASPECT"),
    ("RECTANGULAR_PATTERN", "CHARACTERIZED_OBJECT"),
    ("REMOVAL_VOLUME", "CHARACTERIZED_OBJECT"),
    ("REPLICATE_FEATURE", "CHARACTERIZED_OBJECT"),
    ("REPRESENTATION_PROXY_ITEM", "REPRESENTATION_ITEM"),
    (
        "REPRESENTATIVE_SHAPE_REPRESENTATION",
        "SHAPE_REPRESENTATION",
    ...
    ("RETENTION", "ACTION"),
    ("REVOLVED_PROFILE", "CHARACTERIZED_OBJECT"),
    ("RIB", "CHARACTERIZED_OBJECT"),
    ("RIB_TOP", "CHARACTERIZED_OBJECT"),
    ("RIB_TOP_FLOOR", "SHAPE_ASPECT"),
    ("ROUNDED_END", "CHARACTERIZED_OBJECT"),
    ("ROUNDED_U_PROFILE", "SHAPE_ASPECT"),
    ("ROUND_HOLE", "CHARACTERIZED_OBJECT"),
    ("SCANNED_DATA_ITEM", "GEOMETRIC_REPRESENTATION_ITEM"),
    ("SCANNER_PROPERTY", "REPRESENTATION_ITEM"),
    ("SHAPE_ASPECT_TRANSITION", "SHAPE_ASPECT_RELATIONSHIP"),
    (
    ...
    ("SIN_FUNCTION", "UNARY_NUMERIC_EXPRESSION"),
    ("SLOT", "CHARACTERIZED_OBJECT"),
    ("SLOT_END", "SHAPE_ASPECT"),
    ("SPHERICAL_CAP", "CHARACTERIZED_OBJECT"),
    ("SQUARE_ROOT_FUNCTION", "UNARY_NUMERIC_EXPRESSION"),
    ("SQUARE_U_PROFILE", "SHAPE_ASPECT"),
    ("STEP", "CHARACTERIZED_OBJECT"),
    ("STRING_EXPRESSION", "EXPRESSION"),
    ("STRUCTURED_MESSAGE", "PRODUCT"),
    ("SYSTEM_BREAKDOWN_CONTEXT", "BREAKDOWN_CONTEXT"),
    ("SYSTEM_ELEMENT_USAGE", "BREAKDOWN_ELEMENT_USAGE"),
    ("TAN_FUNCTION", "UNARY_NUMERIC_EXPRESSION"),
    ("TAPER", "SHAPE_ASPECT"),
    ...
    ("TEXTURE_STYLE_SPECIFICATION", "FOUNDED_ITEM"),
    ("TEXTURE_STYLE_TESSELLATION_SPECIFICATION", "FOUNDED_ITEM"),
    ("THREAD", "CHARACTERIZED_OBJECT"),
    ("THREAD_RUNOUT", "SHAPE_ASPECT"),
    ("TRANSITION_FEATURE", "SHAPE_ASPECT"),
    ("TRANSPORT_FEATURE", "SHAPE_ASPECT"),
    ("TURNED_KNURL", "CHARACTERIZED_OBJECT"),
    (
        "TWISTED_CROSS_SECTIONAL_GROUP_SHAPE_ELEMENT",
        "SHAPE_ASPECT",
    ),
    ...
    ("VERIFICATION", "GROUP"),
    ("VOLUME", "GEOMETRIC_REPRESENTATION_ITEM"),
    ("ZONE_BREAKDOWN_CONTEXT", "BREAKDOWN_CONTEXT"),
    ("ZONE_ELEMENT_USAGE", "BREAKDOWN_ELEMENT_USAGE"),
];
static AP203E2_FILE_SCHEMA: &[&str] = &[
    "AP203_CONFIGURATION_CONTROLLED_3D_DESIGN_OF_MECHANICAL_PARTS_AND_ASSEMBLIES_MIM_LF { 1 0 10303 403 2 1 2 }",
];
static AP203E2: SchemaProfile = SchemaProfile {
    legal: AP203E2_LEGAL,
    downgrade: AP203E2_DOWNGRADE,
    file_schema: AP203E2_FILE_SCHEMA,
    apd: ApdInfo {
        status: "international standard",
        name: "config_control_design",
        year: 2010,
        description: "configuration controlled 3D designs of mechanical parts and assemblies",
    },
};
