...
pub use ir::{
    ...
    Ellipse3, Face, FaceId, GeometryLeaf, GeometryPool, Instance, LengthUncertainty, LengthUnit,
    Line2, Line3, NurbsCurve, NurbsCurve2d, NurbsSurface, Orientation, OrientedEdge, Pcurve,
    Placement1dId, Placement2dId, Placement3dId, Plane3, Point2, Point2dId, Point3, PointId,
    Product, ProductId, Shell, ShellId, Solid, SolidAngleUnit, SolidId, SphericalSurface,
