...
pub(crate) fn serialize_advanced_brep_shape_representation_with_id(
    buf: &mut crate::writer::buffer::WriteBuffer,
    id: u64,
    l1: &super::model::EarlyAdvancedBrepShapeRepresentation,
) {
...
pub(crate) fn serialize_solid_angle_unit(
    buf: &mut crate::writer::buffer::WriteBuffer,
    l1: &super::model::EarlySolidAngleUnit,
) -> u64 {
    buf.push_complex(vec![
        (
            "SI_UNIT".into(),
...
pub(crate) fn serialize_solid_angle_unit_with_id(
    buf: &mut crate::writer::buffer::WriteBuffer,
    id: u64,
    l1: &super::model::EarlySolidAngleUnit,
) {
...
pub(crate) fn serialize_styled_item(
    buf: &mut crate::writer::buffer::WriteBuffer,
    l1: &super::model::EarlyStyledItem,
) -> u64 {
    buf.push_simple(
        "STYLED_ITEM",
        vec![
...
pub(crate) fn serialize_over_riding_styled_item(
    buf: &mut crate::writer::buffer::WriteBuffer,
    l1: &super::model::EarlyOverRidingStyledItem,
) -> u64 {
    buf.push_simple(
        ...
        vec![
            ...
            crate::parser::entity::Attribute::EntityRef(l1.item),
            crate::parser::entity::Attribute::EntityRef(l1.over_ridden_style),
        ],
    )
}

pub(crate) fn serialize_context_dependent_over_riding_styled_item(
    buf: &mut crate::writer::buffer::WriteBuffer,
    l1: &super::model::EarlyContextDependentOverRidingStyledItem,
) -> u64 {
    buf.push_simple(
...
pub(crate) fn serialize_coordinates_list(
    buf: &mut crate::writer::buffer::WriteBuffer,
    l1: &super::model::EarlyCoordinatesList,
) -> u64 {
    buf.push_simple(
        "COORDINATES_LIST",
        vec![
            crate::parser::entity::Attribute::String(l1.name.clone()),
            crate::parser::entity::Attribute::Integer(l1.npoints),
            crate::parser::entity::Attribute::List(
                l1.position_coords
                    .iter()
                    .map(|row| {
...
pub(crate) fn serialize_tessellated_curve_set(
    buf: &mut crate::writer::buffer::WriteBuffer,
    l1: &super::model::EarlyTessellatedCurveSet,
) -> u64 {
    buf.push_simple(
...
pub(crate) fn serialize_complex_triangulated_surface_set(
    buf: &mut crate::writer::buffer::WriteBuffer,
    l1: &super::model::EarlyComplexTriangulatedSurfaceSet,
) -> u64 {
    buf.push_simple(
...
pub(crate) fn serialize_tessellated_geometric_set(
    buf: &mut crate::writer::buffer::WriteBuffer,
    l1: &super::model::EarlyTessellatedGeometricSet,
) -> u64 {
    buf.push_simple(
...
pub(crate) fn serialize_tessellated_shell(
    buf: &mut crate::writer::buffer::WriteBuffer,
    l1: &super::model::EarlyTessellatedShell,
) -> u64 {
    buf.push_simple(
        "TESSELLATED_SHELL",
        vec![
...
pub(crate) fn serialize_repositioned_tessellated_item(
    buf: &mut crate::writer::buffer::WriteBuffer,
    l1: &super::model::EarlyRepositionedTessellatedItem,
) -> u64 {
    buf.push_simple(
...
pub(crate) fn serialize_constructive_geometry_representation(
    buf: &mut crate::writer::buffer::WriteBuffer,
    l1: &super::model::EarlyConstructiveGeometryRepresentation,
) -> u64 {
    buf.push_simple(
...
fn si_prefix_attr(v: crate::ir::units::SiPrefix) -> crate::parser::entity::Attribute {
    crate::parser::entity::Attribute::Enum(
        match v {
            crate::ir::units::SiPrefix::Atto => "ATTO",
            crate::ir::units::SiPrefix::Centi => "CENTI",
            crate::ir::units::SiPrefix::Deca => "DECA",
            crate::ir::units::SiPrefix::Deci => "DECI",
            crate::ir::units::SiPrefix::Exa => "EXA",
            crate::ir::units::SiPrefix::Femto => "FEMTO",
            crate::ir::units::SiPrefix::Giga => "GIGA",
            crate::ir::units::SiPrefix::Hecto => "HECTO",
            crate::ir::units::SiPrefix::Kilo => "KILO",
            crate::ir::units::SiPrefix::Mega => "MEGA",
            crate::ir::units::SiPrefix::Micro => "MICRO",
            crate::ir::units::SiPrefix::Milli => "MILLI",
            crate::ir::units::SiPrefix::Nano => "NANO",
            crate::ir::units::SiPrefix::Peta => "PETA",
            crate::ir::units::SiPrefix::Pico => "PICO",
            crate::ir::units::SiPrefix::Tera => "TERA",
        }
        .into(),
    )
}

fn si_unit_name_attr(v: crate::ir::units::SiUnitName) -> crate::parser::entity::Attribute {
    crate::parser::entity::Attribute::Enum(
        match v {
            crate::ir::units::SiUnitName::Ampere => "AMPERE",
            crate::ir::units::SiUnitName::Becquerel => "BECQUEREL",
            crate::ir::units::SiUnitName::Candela => "CANDELA",
            crate::ir::units::SiUnitName::Coulomb => "COULOMB",
            crate::ir::units::SiUnitName::DegreeCelsius => "DEGREE_CELSIUS",
            crate::ir::units::SiUnitName::Farad => "FARAD",
            crate::ir::units::SiUnitName::Gram => "GRAM",
            crate::ir::units::SiUnitName::Gray => "GRAY",
            crate::ir::units::SiUnitName::Henry => "HENRY",
            crate::ir::units::SiUnitName::Hertz => "HERTZ",
            crate::ir::units::SiUnitName::Joule => "JOULE",
            crate::ir::units::SiUnitName::Kelvin => "KELVIN",
            crate::ir::units::SiUnitName::Lumen => "LUMEN",
            crate::ir::units::SiUnitName::Lux => "LUX",
            crate::ir::units::SiUnitName::Metre => "METRE",
            crate::ir::units::SiUnitName::Mole => "MOLE",
            crate::ir::units::SiUnitName::Newton => "NEWTON",
            crate::ir::units::SiUnitName::Ohm => "OHM",
            crate::ir::units::SiUnitName::Pascal => "PASCAL",
            crate::ir::units::SiUnitName::Radian => "RADIAN",
            crate::ir::units::SiUnitName::Second => "SECOND",
            crate::ir::units::SiUnitName::Siemens => "SIEMENS",
            crate::ir::units::SiUnitName::Sievert => "SIEVERT",
            crate::ir::units::SiUnitName::Steradian => "STERADIAN",
            crate::ir::units::SiUnitName::Tesla => "TESLA",
            crate::ir::units::SiUnitName::Volt => "VOLT",
            crate::ir::units::SiUnitName::Watt => "WATT",
            crate::ir::units::SiUnitName::Weber => "WEBER",
        }
        .into(),
    )
}
