...
pub(crate) fn bind_shape_representation(
    entity_id: u64,
    attrs: &[crate::parser::entity::Attribute],
) -> Result<super::model::EarlyShapeRepresentation, crate::ir::error::ConvertError> {
    crate::ir::attr::check_count(attrs, 3, entity_id, "SHAPE_REPRESENTATION")?;
    Ok(super::model::EarlyShapeRepresentation {
        name: crate::ir::attr::read_string_or_unset(attrs, 0, entity_id, "name")?.to_owned(),
...
pub(crate) fn bind_advanced_brep_shape_representation(
    entity_id: u64,
    attrs: &[crate::parser::entity::Attribute],
) -> Result<super::model::EarlyAdvancedBrepShapeRepresentation, crate::ir::error::ConvertError> {
    crate::ir::attr::check_count(attrs, 3, entity_id, "ADVANCED_BREP_SHAPE_REPRESENTATION")?;
    Ok(super::model::EarlyAdvancedBrepShapeRepresentation {
        name: crate::ir::attr::read_string_or_unset(attrs, 0, entity_id, "name")?.to_owned(),
        items: crate::ir::attr::read_entity_ref_list(attrs, 1, entity_id, "items")?,
        context_of_items: crate::ir::attr::read_entity_ref(
            attrs,
...
pub(crate) fn bind_draughting_model(
    entity_id: u64,
    attrs: &[crate::parser::entity::Attribute],
) -> Result<super::model::EarlyDraughtingModel, crate::ir::error::ConvertError> {
    crate::ir::attr::check_count(attrs, 3, entity_id, "DRAUGHTING_MODEL")?;
    Ok(super::model::EarlyDraughtingModel {
        name: crate::ir::attr::read_string_or_unset(attrs, 0, entity_id, "name")?.to_owned(),
        items: crate::ir::attr::read_entity_ref_list(attrs, 1, entity_id, "items")?,
        context_of_items: crate::ir::attr::read_entity_ref(
            attrs,
...
pub(crate) fn bind_presentation_view(
    entity_id: u64,
    attrs: &[crate::parser::entity::Attribute],
) -> Result<super::model::EarlyPresentationView, crate::ir::error::ConvertError> {
    crate::ir::attr::check_count(attrs, 3, entity_id, "PRESENTATION_VIEW")?;
    Ok(super::model::EarlyPresentationView {
        name: crate::ir::attr::read_string_or_unset(attrs, 0, entity_id, "name")?.to_owned(),
        items: crate::ir::attr::read_entity_ref_list(attrs, 1, entity_id, "items")?,
        context_of_items: crate::ir::attr::read_entity_ref(
            attrs,
...
pub(crate) fn bind_presentation_area(
    entity_id: u64,
    attrs: &[crate::parser::entity::Attribute],
) -> Result<super::model::EarlyPresentationArea, crate::ir::error::ConvertError> {
    crate::ir::attr::check_count(attrs, 3, entity_id, "PRESENTATION_AREA")?;
    Ok(super::model::EarlyPresentationArea {
        name: crate::ir::attr::read_string_or_unset(attrs, 0, entity_id, "name")?.to_owned(),
        items: crate::ir::attr::read_entity_ref_list(attrs, 1, entity_id, "items")?,
        context_of_items: crate::ir::attr::read_entity_ref(
            attrs,
...
pub(crate) fn bind_geometric_item_specific_usage(
    entity_id: u64,
    attrs: &[crate::parser::entity::Attribute],
) -> Result<super::model::EarlyGeometricItemSpecificUsage, crate::ir::error::ConvertError> {
    crate::ir::attr::check_count(attrs, 5, entity_id, "GEOMETRIC_ITEM_SPECIFIC_USAGE")?;
    Ok(super::model::EarlyGeometricItemSpecificUsage {
        name: crate::ir::attr::read_string_or_unset(attrs, 0, entity_id, "name")?.to_owned(),
        description: crate::ir::attr::read_optional_string(attrs, 1, entity_id, "description")?,
        definition: crate::ir::attr::read_entity_ref(attrs, 2, entity_id, "definition")?,
        used_representation: crate::ir::attr::read_entity_ref(
