...
/// Lossless subtype->supertype downgrades for ap214e3 output (UPPER wire form,
/// sorted by subtype for binary_search). Renamed before drop on cross-AP projection.
pub(crate) const AP214E3_DOWNGRADE: &[(&str, &str)] = &[
    (
...
/// Lossless subtype->supertype downgrades for ap242e2 output (UPPER wire form,
/// sorted by subtype for binary_search). Renamed before drop on cross-AP projection.
pub(crate) const AP242E2_DOWNGRADE: &[(&str, &str)] = &[
    ("COMPOSITE_ASSEMBLY_DEFINITION", "PRODUCT_DEFINITION"),
...
/// Lossless subtype->supertype downgrades for ap203e2 output (UPPER wire form,
/// sorted by subtype for binary_search). Renamed before drop on cross-AP projection.
pub(crate) const AP203E2_DOWNGRADE: &[(&str, &str)] = &[
    (
        "A3MA_LENGTH_MEASURE_AND_CONTEXT_DEPENDENT_MEASURE_PAIR",
        "COMPOUND_REPRESENTATION_ITEM",
    ),
