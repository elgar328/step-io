...
pub(crate) use super::generated::bind::{
    bind_application_context, bind_approval_role, bind_approval_status,
    bind_constructive_geometry_representation_relationship,
    bind_context_dependent_shape_representation, bind_date_time_role, bind_document_type,
    bind_fill_area_style, bind_group, bind_identification_role,
    bind_mechanical_design_and_draughting_relationship, bind_next_assembly_usage_occurrence,
    bind_object_role, bind_person_and_organization_role, bind_point_style, bind_product,
