...
pub(crate) use super::generated::bind::{
    ...
    bind_approval_status, bind_calendar_date,
    ...
    bind_object_role, bind_organization, bind_person, bind_person_and_organization_role,
    bind_personal_address, bind_point_style, bind_product, bind_product_definition,
