...
pub(crate) use super::generated::serialize::{
    ...
    serialize_document_representation_type, serialize_document_type, serialize_fill_area_style,
    serialize_group, serialize_identification_role, serialize_local_time,
    ...
    serialize_personal_address, serialize_point_style, serialize_product,
